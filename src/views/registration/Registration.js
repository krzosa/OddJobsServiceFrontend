            ...
            <div className="container content">
                <div className="form-check">
                    ...
                    <div className="form-group col-12 my-3 text-center mb-4">
                        ...
                        <label className="form-check-label col-8 col-md-6 col-lg-4" htmlFor="przykladowyCheckbox">Oświadczam że znam i akceptuję postanowienia Regulaminu.</label>
                    </div>
                    <div className="col-12 text-center" >
                    <button type="submit" className="btn btn-info col-8 col-md-6 col-lg-4 mb-5 ">Zarejestruj się</button>
                    </div>
                </div>
            </div>
        );
